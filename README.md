...
This project was developed as part of Data Analyst Internship – Task 4 (Dashboard Design).
The objective of this project is to design an interactive business dashboard that enables stakeholders to monitor sales performance, profitability, customer behavior, and operational efficiency using real transactional data.

The dashboard is built using Power BI and presents key metrics and insights in a single, executive-friendly view to support data-driven decision-making.
...
│── SuperStore Sales & Performance Dashboard Documentation.pdf
│── README.md
